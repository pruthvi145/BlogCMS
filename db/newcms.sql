...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2019 at 05:49 AM
...
(41, 362, 'dcvsdvdsv', 'vdsvdvsv', 'dsvdsvdsvsv', 'approved', '0000-00-00');
...
(359, 56, 'java demo post', 'Pruthvi Patel', '0000-00-00', 'Screenshot (1).png', 'there are huge content of lorem ipsum', 'new tag', 0, 'published'),
...
(369, 58, 'Demo post ', 'Pruthvi Patel', '0000-00-00', 'myAvatar.png', 'there are huge content of lorem ipsum', 'new tag', 0, 'published');
...
--
ALTER TABLE `posts`
  MODIFY `post_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=370;
COMMIT;
